module "my_oregon_transit_gateway" {
  ...
  peering_attachments = [
    {
      peer_transit_gateway_id = module.my_virginia_transit_gateway.tgw.id
  ...
  vpc_attachment_accepters = [
    {
      transit_gateway_attachment_id = "tgw-attach-123123"
  ...
  peering_attachment_accepters = [
    {
      ...
      transit_gateway_attachment_id = module.my_oregon_transit_gateway.peering_attachments[module.my_virginia_transit_gateway.tgw.id].id
